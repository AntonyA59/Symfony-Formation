...
{ 
    ...
    {
        // 0. Securistaion : Est-ce que le produit existe ? 
        ...
        $this->addFlash('success', "Le produit a bien etait ajouté au panier");
    ...
    public function delete($id) {
        ...
        if(!$product){
            throw $this->createNotFoundException("Le produit $id n'existe pas et ne peux pas être suprimé !");
        }
